public class Book {
    ...
    // using conversion rate, calculate EUR, RUB of book
    ...
    public static void main(String[] args) {
        ...
        Book book1 = new Book();
        book1.createNewBook("Harry Potter", "J.K. Rolling", 1, 10.5, false);
        book1.createNewBook("Anna Karenina", "Lev Tolstoy", 2, 20, true);
